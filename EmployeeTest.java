...
public class EmployeeTest extends TestCase
{
	...
	/**
	 * Tests the default constructor. It expects that the defaults for the name
	 * are "New First", "New Last" and 0.00 for the salary
	 */
	@Test
	public void testEmployeeDefaultConstructor()
	{
				...
				&& expectedSalary.equals(emp.getFormattedSalary())))
		{
			...
			if(!expectedFirst.equals(emp.getFirstName()))
			{
				msg += String.format("First - name: Expected: %s, actual: %s\n",
						expectedFirst, emp.getFirstName());
			}

			if(!expectedLast.equals(emp.getLastName()))
			{
				msg += String.format("Last name - Expected: %s, actual: %s\n",
						expectedLast, emp.getLastName());
			}

			if(!expectedSalary.equalsIgnoreCase(emp.getFormattedSalary()))
			{
	...
	/**
	 * Tests the two parameter constructor. It expects that the values for the
	 * name are "Scott", "LaChance" and 0.00 for the salary
	 */
	@Test
	...
	/**
	 * Tests the two parameter constructor. It expects that the values for the
	 * name are "Scott", "LaChance" and 5,005.65 for the salary
	 */
	@Test
	...
	/**
	 * Tests that two Employee instances are equal. Verifies that the equals
	...
	/**
	 * Tests thetwo Employee instances are not equal. Verifies that the equals
	 * method is overloaded correctly
	 */
	@Test
	...
	/**
	 * Tests the display name is correct. It expects that the values for the
	 * name are "LaChance, Scott"
	 */
	@Test
	public void testDisplayName()
	{
		...
		if(!(expectedDisplayName.equals(emp.getDisplayName())))
		{
			String msg = String.format(
					"Display name - name: Expected: %s, actual: %s\n",
	...
	/**
	 * Tests the toString implementation is. It expects that the values for the
	 * name are "LaChance, Scott Salary: $5,005.65"
	 */
	@Test
	public void testToString()
	{
		...
		{
			String msg = String.format(
					"toString - name: Expected: %s, actual: %s\n", expected,
					emp.toString());
			fail("testDisplayName doesn't return expected values\n" + msg);
		}
	}
